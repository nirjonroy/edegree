...
return new class extends Migration
{
    public function up()
    {
        Schema::create('siteinfo', function (Blueprint $table) {
            ...
            $table->unsignedInteger('favicon_width')->nullable();
            $table->unsignedInteger('favicon_height')->nullable();
            $table->string('image_output_format', 10)->default('webp');
            ...
            $table->unsignedInteger('slider_width')->nullable();
            $table->unsignedInteger('slider_height')->nullable();
            $table->unsignedInteger('about_image_width')->nullable();
            $table->unsignedInteger('about_image_height')->nullable();
            $table->unsignedInteger('property_image_width')->nullable();
            $table->unsignedInteger('property_image_height')->nullable();
            $table->unsignedInteger('blog_post_image_width')->nullable();
            $table->unsignedInteger('blog_post_image_height')->nullable();
            $table->unsignedInteger('blog_page_image_width')->nullable();
            $table->unsignedInteger('blog_page_image_height')->nullable();
            $table->unsignedInteger('agency_logo_width')->nullable();
            $table->unsignedInteger('agency_logo_height')->nullable();
            $table->timestamps();
        });
    }
